...
export default class resumeCommand extends Command {
    public async exec(msg: Message, args: string[]) {
        ...
        if (msg.guild?.queue && voiceChannel.id !== msg.guild.queue?.voiceChannel.id)return msg.channel.send(`You must be in **${msg.guild.queue?.voiceChannel.name}** to resume music`);
